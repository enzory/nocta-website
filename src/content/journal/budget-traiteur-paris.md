...
Ce prix inclut systématiquement : la conception du menu sur-mesure, les courses et produits, la préparation sur place, le service à table, et le nettoyage complet de la cuisine en fin de soirée. Il n'y a pas de frais cachés.

À retenir : pas de minimum de convives chez NOCTA. Le minimum de commande est de 500 € HT. Concrètement, un dîner pour 6 personnes à 85 € par personne est tout à fait réalisable.

## Cocktail et amuses-bouches : environ 4,50 € la pièce
...
## Dîner corporate : 70 à 250 € par personne
...
Pour les séjours en villa (Saint-Tropez, Côte d'Azur, campagne) ou les séminaires résidentiels, le chef se déplace sur plusieurs jours. Le tarif est établi sur devis en fonction de la durée, du nombre de repas, et de la localisation. Le transport est à la charge du client.

C'est un format que nous connaissons bien — NOCTA a assuré des séjours complets avec petit-déjeuner, déjeuner et dîner, dans des villas privées en France.

## Ce qui fait varier le prix d'un traiteur

Quatre facteurs principaux déterminent le budget final.

Le premier est le menu : un menu en 3 temps avec des produits de saison coûte moins qu'un 5 temps avec du homard et de la truffe. Logique, mais important à préciser.

Le deuxième est le nombre de convives : plus il y a de monde, plus le coût par personne peut baisser sur certains postes (déplacement, mise en place). Mais chez NOCTA, il n'y a pas de minimum de convives — juste un minimum de commande à 500 € HT.

Le troisième est le lieu : un dîner à domicile avec une cuisine équipée ne coûte pas la même chose qu'un événement dans un loft vide où il faut tout apporter.

Le quatrième est le niveau de service : service à table avec sommelier, simple dépose, ou cocktail debout — chaque format a sa logistique et son coût.

## Comment obtenir un devis précis

Chaque événement NOCTA est sur-mesure. Les fourchettes ci-dessus donnent un ordre de grandeur réaliste, mais le seul moyen d'avoir un prix exact est de nous décrire votre projet.

Vous pouvez nous contacter directement pour un devis gratuit. Nous répondons sous 48 heures avec une proposition détaillée — menu, budget, déroulé complet.

NOCTA est un service de traiteur et chef privé haut de gamme basé à Paris, fondé par Hugo Vinatier (chef formé à L'Astrance 3 étoiles, Akrame, aux côtés de Thierry Marx) et Enzo Ryon (maître d'hôtel et sommelier, 14 ans en haute gastronomie étoilée). Nous intervenons à Paris, en Île-de-France, et partout en France pour des dîners privés, événements corporate et expériences culinaires sur-mesure.
